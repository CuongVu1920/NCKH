...
<nav>
    <ul class="pagination justify-content-center">
        <?php if ($current_page > 1): ?>
            <li class="page-item">
                <a class="page-link" href="admin_dashboard.php?page_layout=student_list&idpage=1">Đầu</a>
            </li>
            <li class="page-item">
                <a class="page-link" href="admin_dashboard.php?page_layout=student_list&idpage=<?php echo ($current_page - 1); ?>">Trước</a>
            </li>
        <?php endif; ?>

        <?php for ($i = 1; $i <= $number_of_page; $i++): ?>
            <li class="page-item <?php echo ($i == $current_page) ? 'active' : ''; ?>">
                <a class="page-link" href="admin_dashboard.php?page_layout=student_list&idpage=<?php echo $i; ?>"><?php echo $i; ?></a>
            </li>
        <?php endfor; ?>

        <?php if ($current_page < $number_of_page): ?>
            <li class="page-item">
                <a class="page-link" href="admin_dashboard.php?page_layout=student_list&idpage=<?php echo ($current_page + 1); ?>">Tiếp</a>
            </li>
            <li class="page-item">
                <a class="page-link" href="admin_dashboard.php?page_layout=student_list&idpage=<?php echo $number_of_page; ?>">Cuối</a>
            </li>
        <?php endif; ?>
    </ul>
</nav>
