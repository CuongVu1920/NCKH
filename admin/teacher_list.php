        ...
        <table class="teacher-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="act-btn">
                            <a href="admin_dashboard.php?page_layout=update_teacher&id=<?= $row['id'] ?>" class="edit-btn">Sửa</a>
                            <a href="admin_dashboard.php?page_layout=delete_user_process&id=<?= $row['id'] ?>" class="delete-btn" onclick="return confirm('Bạn có chắc muốn xóa giảng viên này không?');">Xóa</a>
                        </div>
                    </td>
                </tr>
                <?php endwhile; ?>
